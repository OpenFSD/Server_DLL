...
namespace Server_Library
{
    ...
    class WaitEnableWrite::WriteEnable_Stack_Server_InputAction_Framework* Execute::ptr_WriteEnable_Stack_InputPraise = NULL;
    class WaitEnableWrite::WriteEnable_Stack_Server_OutputRecieve_Framework* Execute::ptr_WriteEnable_Stack_OutputPraise = NULL;
    ...
    )
    {
        ...
        ptr_WriteEnable_Stack_InputPraise = new class WaitEnableWrite::WriteEnable_Stack_Server_InputAction_Framework();
        ...
        ptr_WriteEnable_Stack_OutputPraise = new class WaitEnableWrite::WriteEnable_Stack_Server_OutputRecieve_Framework();
    ...
    class WaitEnableWrite::WriteEnable_Stack_Server_InputAction_Framework* Execute::Get_WriteEnable_Stack_InputPraise()
    {
        return ptr_WriteEnable_Stack_InputPraise;
    }

    class WaitEnableWrite::WriteEnable_Stack_Server_OutputRecieve_Framework* Execute::Get_WriteEnable_Stack_OutputPraise()
    {
