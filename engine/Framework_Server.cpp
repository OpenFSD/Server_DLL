...
namespace Server_Library
{
	...
	void Framework_Server::Request_Wait_Launch_ConcurrentThread()
	{
	}
	...
	WaitEnableWrite::Framework_WriteEnable_Server_InputAction* Framework_Server::Get_WriteEnable_Stack_InputPraise()
	{
		return Server_Library::Framework_Server::Get_HostServer()->Get_Execute()->Get_WriteEnable_Stack_InputPraise();
	}

	WaitEnableWrite::Framework_WriteEnable_Server_OutputRecieve* Framework_Server::Get_WriteEnable_Stack_OutputPraise()
	{
