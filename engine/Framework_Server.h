...
namespace Server_Library
{
    ...
    public:
        ...
        static Server_Library::Server Get_HostServer();
        static int Get_NumberOfCores();
        static bool GetState_Buffer_Input_ToWrite();
        static WaitEnableWrite::WriteEnable* Get_WriteEnable_Stack_InputPraise();
        static WaitEnableWrite::WriteEnable* Get_WriteEnable_Stack_OutputPraise();
