...
{
    bool LaunchConcurrency_Control_Server::state_ConcurrentCore[3] = { NULL, NULL, NULL };//NUMBER OF CONCURRENT CORES
    bool LaunchConcurrency_Control_Server::flag_praisingLaunch = NULL;
    unsigned char LaunchConcurrency_Control_Server::concurrent_CoreId_Index = NULL;
    int LaunchConcurrency_Control_Server::count_LaunchActive_For[3] = { NULL, NULL, NULL };//NUMBER OF CONCURNT CORES
    int LaunchConcurrency_Control_Server::count_LaunchIdle_For[3] = { NULL, NULL, NULL };//NUMBER OF CONCURNT CORES
    unsigned char LaunchConcurrency_Control_Server::new_concurrent_CoreId_Index = NULL;
    unsigned char LaunchConcurrency_Control_Server::que_CoreToLaunch[3] = { NULL, NULL, NULL };//NUMBER OF CONCURRENT CORES
    
    std::vector<unsigned char>* LaunchConcurrency_Control_Server::stack_PriseEventId;

    LaunchConcurrency_Control_Server::LaunchConcurrency_Control_Server(
        ConcurrentQue::Global_ConcurrentQue_Server* ptr_Global,
    ...
    void LaunchConcurrency_Control_Server::LaunchEnable_Activate(
    ...
    void LaunchConcurrency_Control_Server::LaunchEnable_Request(
    ...
    void LaunchConcurrency_Control_Server::LaunchEnable_SortQue(
        class ConcurrentQue::Global_ConcurrentQue_Server* ptr_Global,
        unsigned char number_Implemented_Cores
    )
    {
    ...
    void LaunchConcurrency_Control_Server::LaunchQue_Update(
        unsigned char number_Implemented_Cores
    )
    {
    ...
    unsigned char LaunchConcurrency_Control_Server::Get_concurrent_CoreId_Index()
    {
        return concurrent_CoreId_Index;
    }

    unsigned char LaunchConcurrency_Control_Server::Get_coreId_To_Launch()
    {
        return que_CoreToLaunch[0];
    }

    bool LaunchConcurrency_Control_Server::Get_State_ConcurrentCore(unsigned char concurrent_CoreId)
    {
        return state_ConcurrentCore[concurrent_CoreId];
    }

    void LaunchConcurrency_Control_Server::SetFlag_PraisingLaunch(bool value)
    {
        flag_praisingLaunch = value;
    }

    unsigned char LaunchConcurrency_Control_Server::Get_new_concurrent_CoreId_Index()
    {
        return new_concurrent_CoreId_Index;
    }

    std::vector<unsigned char>* LaunchConcurrency_Control_Server::Get_Stack_PriseEventId()
    {
        return stack_PriseEventId;
    }

    void LaunchConcurrency_Control_Server::Set_concurrent_CoreId_Index(unsigned char value)
    {
        concurrent_CoreId_Index = value;
    }

    void LaunchConcurrency_Control_Server::SetFlag_ConcurrentCoreState(unsigned char concurrent_CoreId, bool value)
    {
        state_ConcurrentCore[concurrent_CoreId] = value;
    }


    bool LaunchConcurrency_Control_Server::GetFlag_PraisingLaunch()
    {
        return flag_praisingLaunch;
    }

    void LaunchConcurrency_Control_Server::Set_new_concurrent_CoreId_Index(unsigned char value)
    {
        new_concurrent_CoreId_Index = value;
    }

    void LaunchConcurrency_Control_Server::DynamicStagger(
    ...
    void LaunchConcurrency_Control_Server::LaunchEnable_ShiftQueValues(
    ...
    int LaunchConcurrency_Control_Server::Get_count_LaunchActive_For(unsigned char concurrent_CoreId)
    {
        return count_LaunchActive_For[concurrent_CoreId];
    }

    int LaunchConcurrency_Control_Server::Get_count_LaunchIdle_For(unsigned char concurrent_CoreId)
    {
        return count_LaunchIdle_For[concurrent_CoreId];
    }

    unsigned char LaunchConcurrency_Control_Server::GetFlag_CoreId_Of_CoreToLaunch()
    {
        return que_CoreToLaunch[0];
    }

    unsigned char LaunchConcurrency_Control_Server::Get_que_CoreToLaunch(unsigned char index)
    {
        return que_CoreToLaunch[index];
    }

    void LaunchConcurrency_Control_Server::Set_count_LaunchActive_For(unsigned char concurrent_CoreId, int value)
    {
        count_LaunchActive_For[concurrent_CoreId] = value;
    }

    void LaunchConcurrency_Control_Server::Set_count_LaunchIdle_For(unsigned char concurrent_CoreId, int value)
    {
        count_LaunchIdle_For[concurrent_CoreId] = value;
    }

    void LaunchConcurrency_Control_Server::Set_que_CoreToLaunch(unsigned char concurrent_CoreId, unsigned char value)
    {
