...
namespace WaitEnableWrite
{
    ...
    void WriteEnable_Control_Stack_Server_InputAction::WriteEnable_SortQue(
        class WaitEnableWrite::Global_WriteEnable_Stack_Server_InputAction* ptr_Global
    )
    {
    ...
    void WriteEnable_Control_Stack_Server_InputAction::SetFlag_readWrite_Open(bool value)
    {
        praisingWrite = value;
    }
    ...
    bool WriteEnable_Control_Stack_Server_InputAction::GetFlag_readWrite_Open()
    {
