...
{
    unsigned char WriteEnable_Control_Server_OutputRecieve::coreId_For_WritePraise_Index = NULL;
    int WriteEnable_Control_Server_OutputRecieve::ptr_count_CoreId_WriteActive[4] = { NULL, NULL, NULL, NULL };//NUMBER OF CORES
    int WriteEnable_Control_Server_OutputRecieve::ptr_count_CoreId_WriteIdle[4] = { NULL, NULL, NULL, NULL };//NUMBER OF CORES
    int WriteEnable_Control_Server_OutputRecieve::ptr_count_CoreId_WriteWait[4] = { NULL, NULL, NULL, NULL };//NUMBER OF CORES
    bool WriteEnable_Control_Server_OutputRecieve::flag_WriteState[4][2] = { {NULL, NULL}, {NULL, NULL}, {NULL, NULL}, {NULL, NULL} };//NUMBER OF CORES
    unsigned char WriteEnable_Control_Server_OutputRecieve::ptr_new_coreId_For_WritePraise_Index = NULL;
    bool WriteEnable_Control_Server_OutputRecieve::praisingWrite = NULL;
    unsigned char WriteEnable_Control_Server_OutputRecieve::ptr_que_CoreToWrite[4] = { NULL, NULL, NULL, NULL };//NUMBER OF CORES

    WriteEnable_Control_Server_OutputRecieve::WriteEnable_Control_Server_OutputRecieve(
        class WaitEnableWrite::Global_WriteEnable_Server_OutputRecieve* ptr_Global
    )
    {
    ...
    void WriteEnable_Control_Server_OutputRecieve::WriteEnable_Activate(
    ...
    void WriteEnable_Control_Server_OutputRecieve::WriteEnable_SortQue(
        class WaitEnableWrite::Global_WriteEnable_Server_OutputRecieve* ptr_Global
    )
    {
    ...
    void WriteEnable_Control_Server_OutputRecieve::WriteEnable_Request(
        unsigned char coreId,
        class WaitEnableWrite::Global_WriteEnable_Server_OutputRecieve* ptr_Global
    )
    {
    ...
    void WriteEnable_Control_Server_OutputRecieve::WriteQue_Update(class WaitEnableWrite::Global_WriteEnable_Server_OutputRecieve* ptr_Global)
    {
        for (unsigned char index = 0; index < ptr_Global->Get_NumCores(); index++)
        {
    ...
    unsigned char WriteEnable_Control_Server_OutputRecieve::Get_coreIdForWritePraiseIndex()
    {
        return coreId_For_WritePraise_Index;
    }
    int WriteEnable_Control_Server_OutputRecieve::Get_count_WriteActive(unsigned char coreId)
    {
        return ptr_count_CoreId_WriteActive[coreId];
    }
    int WriteEnable_Control_Server_OutputRecieve::Get_count_WriteIdle(unsigned char coreId)
    {
        return ptr_count_CoreId_WriteIdle[coreId];
    }
    int WriteEnable_Control_Server_OutputRecieve::Get_count_WriteWait(unsigned char coreId)
    {
        return ptr_count_CoreId_WriteWait[coreId];
    }
    unsigned char WriteEnable_Control_Server_OutputRecieve::GetFlag_CoreId_WriteEnable()
    {
        return ptr_que_CoreToWrite[0];
    }
    unsigned char WriteEnable_Control_Server_OutputRecieve::Get_new_coreIdForWritePraiseIndex()
    {
        return ptr_new_coreId_For_WritePraise_Index;
    }
    unsigned char WriteEnable_Control_Server_OutputRecieve::Get_que_CoreToWrite(unsigned char index)
    {
        return ptr_que_CoreToWrite[index];
    }

    void WriteEnable_Control_Server_OutputRecieve::Set_count_WriteActive(unsigned char coreId, int value)
    {
        ptr_count_CoreId_WriteActive[coreId] = value;
    }
    void WriteEnable_Control_Server_OutputRecieve::Set_count_WriteIdle(unsigned char coreId, int value)
    {
        ptr_count_CoreId_WriteIdle[coreId] = value;
    }
    void WriteEnable_Control_Server_OutputRecieve::Set_count_WriteWait(unsigned char coreId, int value)
    {
        ptr_count_CoreId_WriteWait[coreId] = value;
    }
    void WriteEnable_Control_Server_OutputRecieve::SetFlag_readWrite_Open(bool value)
    {
        praisingWrite = value;
    }
    void WriteEnable_Control_Server_OutputRecieve::SetFlag_writeState(unsigned char coreId, unsigned char index, bool value)
    {
        flag_WriteState[coreId][index] = value;
    }
    void WriteEnable_Control_Server_OutputRecieve::Set_new_coreIdForWritePraiseIndex(unsigned char value)
    {
        ptr_new_coreId_For_WritePraise_Index = value;
    }
    void WriteEnable_Control_Server_OutputRecieve::Set_que_CoreToWrite(unsigned char index, unsigned char value)
    {
        ptr_que_CoreToWrite[index] = value;
    }

    void WriteEnable_Control_Server_OutputRecieve::DynamicStagger(
        unsigned char coreId
    )
    {
        if (Get_coreIdForWritePraiseIndex() == coreId)
    ...
    void WriteEnable_Control_Server_OutputRecieve::WriteEnable_ShiftQueValues(
    ...
    bool WriteEnable_Control_Server_OutputRecieve::GetFlag_readWrite_Open()
    {
        return praisingWrite;
    }

    bool WriteEnable_Control_Server_OutputRecieve::GetFlag_writeState(unsigned char coreId, unsigned char index)
    {
        return flag_WriteState[coreId][index];
    }

    void WriteEnable_Control_Server_OutputRecieve::Set_coreIdForWritePraiseIndex(unsigned char value)
    {
