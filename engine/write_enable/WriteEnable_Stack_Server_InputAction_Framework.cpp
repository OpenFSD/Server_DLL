...
namespace WaitEnableWrite
{
	...
	void WriteEnable_Stack_Server_InputAction_Framework::Write_End(__int8 coreId)
	{
		ptr_WriteEnable->Write_End(coreId);
	}

	void WriteEnable_Stack_Server_InputAction_Framework::Write_Start(__int8 coreId)
	{
